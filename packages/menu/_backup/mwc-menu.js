...
let Menu = class Menu extends BaseElement {
    ...
    createAdapter() {
        return Object.assign({}, addHasRemoveClass(this.mdcRoot), { addClassToElementAtIndex: (index, className) => {
...
__decorate([
    property({ type: Boolean })
], Menu.prototype, "autofocus", void 0);
__decorate([
    property({ type: Boolean })
], Menu.prototype, "autoclose", void 0);
__decorate([
    property({ type: Boolean })
], Menu.prototype, "noWrapFocus", void 0);
Menu = __decorate([
